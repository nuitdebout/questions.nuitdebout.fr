...
class qa_75mars
{
	...
	public function process_request($request)
	{
		...
		$categoryslugs = ['decisions-75-mars-paris'];
		$selectsort = 'netvotes';
		...
		$qa_content['title'] = qa_lang_html('75mars/page_title');
		$qa_content['custom'] = qa_lang('75mars/custom');
		$qa_content['sidepanel'] = qa_lang('75mars/sidepanel');
