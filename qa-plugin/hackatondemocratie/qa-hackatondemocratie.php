...
class qa_hackatondemocratie
{
	...
	{
		return $request == 'e-democratie-pour-nd';
	}
	...
	public function process_request($request)
	{
		...
		$qa_content['title'] = qa_lang_html('hackatondemocratie/page_title');
		$qa_content['custom'] = qa_lang('hackatondemocratie/custom');
